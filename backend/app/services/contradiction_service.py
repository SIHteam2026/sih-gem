    ...
    if isinstance(evidence, EvidenceObservation) or (hasattr(evidence, "observed_value") and hasattr(evidence, "evidence_id")):
        ...
        records.append(
            ProvenanceRecord(
                ...
                sheet_name=getattr(evidence, "sheet_name", None),
                row_number=getattr(evidence, "row_number", None),
                location_context=getattr(evidence, "location_context", None),
                source_format=getattr(evidence, "source_format", None),
