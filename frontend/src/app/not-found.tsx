      ...
      <div className="max-w-md w-full bg-white rounded-2xl border border-[#cbd5e1] p-8 shadow-sm text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-[#64748b] leading-relaxed">
            The requested procurement workspace, tender, or submission could not be located.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            href="/procurements"
            className="w-full sm:w-auto focus-ring inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-[#163a5f] hover:bg-[#204c78] rounded-lg transition-colors"
          >
