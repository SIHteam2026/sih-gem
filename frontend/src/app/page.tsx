        ...
        <div className="w-full max-w-3xl space-y-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
              GST Certificate Verifier
            </h1>
            <p className="mt-3 text-lg text-gray-600">
              Upload a GST PDF document to extract, verify, and evaluate evidence in real-time.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
            <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:bg-gray-50 transition-colors">
              ...
              <p className="text-xs text-gray-500 mt-2">PDF files only (e.g. GST REG-06 Certificate)</p>
            </div>
